...
<form action="<?php echo htmlentities($_SERVER['REQUEST_URI']); ?>" method="post">
  ...
  <div class="small_form small_form2">
    ...
    <div class="field">
      ...
      <div class="info">第三方评论服务所提供的评论代码，例如：<a href="http://disqus.com/" target="_blank">Disqus</a>、<a href="http://open.weibo.com/widget/comments.php" target="_blank">新浪微博评论箱</a> 等。设置此选项后，Bigcms就拥有了评论功能。</div>
    </div>
    <div class="clear"></div>
    <div class="field">
      <div class="label"></div>
